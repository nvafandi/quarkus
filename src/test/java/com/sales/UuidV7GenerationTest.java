...
public class UuidV7GenerationTest {
    ...
    public void testUuidV7Generation() {
        UUID uuid = xyz.block.uuidv7.UUIDv7.generate();
    ...
    public void testUuidV7Uniqueness() {
        UUID uuid1 = xyz.block.uuidv7.UUIDv7.generate();
        UUID uuid2 = xyz.block.uuidv7.UUIDv7.generate();
    ...
    public void testUuidV7TimestampExtraction() {
        UUID uuid = xyz.block.uuidv7.UUIDv7.generate();
        long timestamp = xyz.block.uuidv7.UUIDv7.getTimestamp(uuid);
